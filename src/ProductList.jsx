...
function ProductList({ onHomeClick }) {
    ...
    const getTotalCartItems = () => cartItems.reduce((sum, item) => sum + item.quantity, 0);
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleAboutUsClick(e)} style={styleA}>About Us</a></div>
                ...
                <div className="product-grid">
                    {plantsArray.map((categoryObj) => (
                        <div key={categoryObj.category}>
                            <h2 style={{ textAlign: 'center', margin: '20px 0 10px' }}>{categoryObj.category}</h2>
